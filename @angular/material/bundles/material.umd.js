...
var MdChipList = (function () {
    ...
    MdChipList = __decorate$39([
        _angular_core.Component({selector: 'md-chip-list',
            ...
            styles: [".md-chip-list-wrapper { display: flex; flex-direction: row; flex-wrap: wrap; align-items: flex-start; /* * Only apply the margins to chips */ } .md-chip-list-wrapper .md-chip:not(.md-basic-chip) { margin: 0 3px 0 3px; } .md-chip-list-wrapper .md-chip:not(.md-basic-chip):first-child { margin-left: 0; margin-right: 3px; } [dir='rtl'] .md-chip-list-wrapper .md-chip:not(.md-basic-chip):first-child { margin-left: 3px; margin-right: 0; } .md-chip-list-wrapper .md-chip:not(.md-basic-chip):last-child { margin-left: 3px; margin-right: 0; } [dir='rtl'] .md-chip-list-wrapper .md-chip:not(.md-basic-chip):last-child { margin-left: 0; margin-right: 3px; } .md-chip:not(.md-basic-chip) { display: inline-block; padding: 8px 12px 8px 12px; border-radius: 24px; font-size: 13px; line-height: 16px; } .md-chip-list-stacked .md-chip-list-wrapper { display: block; } .md-chip-list-stacked .md-chip-list-wrapper .md-chip:not(.md-basic-chip) { display: block; margin: 0; margin-bottom: 8px; } [dir='rtl'] .md-chip-list-stacked .md-chip-list-wrapper .md-chip:not(.md-basic-chip) { margin: 0; margin-bottom: 8px; } .md-chip-list-stacked .md-chip-list-wrapper .md-chip:not(.md-basic-chip):last-child, [dir='rtl'] .md-chip-list-stacked .md-chip-list-wrapper .md-chip:not(.md-basic-chip):last-child { margin-bottom: 0; } /*# sourceMappingURL=chips.css.map */ "],
            encapsulation: _angular_core.ViewEncapsulation.None,
            changeDetection: _angular_core.ChangeDetectionStrategy.OnPush
        }), 
...
var MdProgressSpinner = (function () {
    ...
    MdProgressSpinner = __decorate$43([
        _angular_core.Component({selector: 'md-progress-spinner, mat-progress-spinner, md-progress-circle, mat-progress-circle',
            ...
            styles: [":host { display: block; height: 100px; width: 100px; overflow: hidden; } :host svg { height: 100%; width: 100%; transform-origin: center; } :host path { fill: transparent; stroke-width: 10px; } :host[mode='indeterminate'] svg { animation-duration: 5250ms, 2887.5ms; animation-name: md-progress-spinner-sporadic-rotate, md-progress-spinner-linear-rotate; animation-timing-function: cubic-bezier(0.35, 0, 0.25, 1), linear; animation-iteration-count: infinite; transition: none; } @keyframes md-progress-spinner-linear-rotate { 0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); } } @keyframes md-progress-spinner-sporadic-rotate { 12.5% { transform: rotate(135deg); } 25% { transform: rotate(270deg); } 37.5% { transform: rotate(405deg); } 50% { transform: rotate(540deg); } 62.5% { transform: rotate(675deg); } 75% { transform: rotate(810deg); } 87.5% { transform: rotate(945deg); } 100% { transform: rotate(1080deg); } } /*# sourceMappingURL=progress-spinner.css.map */ "],
            changeDetection: _angular_core.ChangeDetectionStrategy.OnPush,
        }), 
...
var MdAutocompleteModule = (function () {
    ...
    MdAutocompleteModule = __decorate$69([
        _angular_core.NgModule({
            imports: [DefaultStyleCompatibilityModeModule],
